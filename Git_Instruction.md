...
### 1. <span style="color:#7FFFD4">**Создание файла**</span></font>
...
## 5. <font face="arial black"><span style="color:#ADFF2F">**Просмотр истории коммитов и перемещение между сохранениями**</span></font>
...
### 2. <span style="color:#7FFFD4">**Переход между фиксациями**</span>
...
```
git checkout или команду git switch -
```
...
```
Список веток в репозитории моxxxжно посмотреть с помощью команды
```
git branch
```
Текущая ветка будет отмечеxxxxна  звёздочкой: **\*master**